...
|  --- | --- | --- |
|  [(constructor)(entries, delimiter)](./rush-lib.lookupbypath._constructor_.md) |  | **_(BETA)_** Constructs a new <code>LookupByPath</code> |

## Properties

|  Property | Modifiers | Type | Description |
|  --- | --- | --- | --- |
|  [delimiter](./rush-lib.lookupbypath.delimiter.md) | <code>readonly</code> | string | **_(BETA)_** The delimiter used to split paths |
