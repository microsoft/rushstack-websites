...
| [ignoreMissingResxComments?](./localization-plugin.ilocalizeddata.ignoremissingresxcomments.md)             | boolean                                                                                                                             | <i>(Optional)</i> If set to true, do not warn on missing RESX <data> element comments.                                                                                                                         |
