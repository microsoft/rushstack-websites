...
[Home](./index.md) &gt; [@rushstack/ts-command-line](./ts-command-line.md) &gt; [IBaseCommandLineDefinition](./ts-command-line.ibasecommandlinedefinition.md) &gt; [allowNonStandardEnvironmentVariableNames](./ts-command-line.ibasecommandlinedefinition.allownonstandardenvironmentvariablenames.md)
