...
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [filesToIgnore?](./localization-plugin.ilocalizationpluginoptions.filestoignore.md)             | string\[\]                                                                      | <i>(Optional)</i>                                                                                                                                                          |
| [globsToIgnore?](./localization-plugin.ilocalizationpluginoptions.globstoignore.md)             | string\[\]                                                                      | <i>(Optional)</i> This option is used to specify <code>.resx</code>, <code>.resx.json</code> and <code>.loc.json</code> files that should not be processed by this plugin. |
