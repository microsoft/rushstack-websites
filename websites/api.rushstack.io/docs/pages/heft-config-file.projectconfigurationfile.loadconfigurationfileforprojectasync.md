...
[Home](./index.md) &gt; [@rushstack/heft-config-file](./heft-config-file.md) &gt; [ProjectConfigurationFile](./heft-config-file.projectconfigurationfile.md) &gt; [loadConfigurationFileForProjectAsync](./heft-config-file.projectconfigurationfile.loadconfigurationfileforprojectasync.md)
