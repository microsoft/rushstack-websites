...
[Home](./index.md) &gt; [@rushstack/ts-command-line](./ts-command-line.md) &gt; [CommandLineParameterBase](./ts-command-line.commandlineparameterbase.md) &gt; [appendToArgList](./ts-command-line.commandlineparameterbase.appendtoarglist.md)

## CommandLineParameterBase.appendToArgList() method
