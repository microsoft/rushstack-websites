...
|  [forbidPhantomResolvableNodeModulesFolders?](./rush-lib.iexperimentsjson.forbidphantomresolvablenodemodulesfolders.md) |  | boolean | **_(BETA)_** _(Optional)_ If true, Rush will not allow node\_modules in the repo folder or in parent folders. |
...
|  [printEventHooksOutputToConsole?](./rush-lib.iexperimentsjson.printeventhooksoutputtoconsole.md) |  | boolean | **_(BETA)_** _(Optional)_ If true, print the outputs of shell commands defined in event hooks to the console. |
