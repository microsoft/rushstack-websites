...
| [phasedCommands?](./rush-lib.iexperimentsjson.phasedcommands.md)                                                                   | boolean | <b><i>(BETA)</i></b> <i>(Optional)</i> If true, the phased commands feature is enabled. To use this feature, create a "phased" command in common/config/rush/command-line.json.                                                                                                                                      |
