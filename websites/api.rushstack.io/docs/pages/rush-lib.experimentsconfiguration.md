...
|  --- | --- | --- | --- |
|  [configuration](./rush-lib.experimentsconfiguration.configuration.md) | <code>readonly</code> | Readonly&lt;[IExperimentsJson](./rush-lib.iexperimentsjson.md)<></>&gt; | **_(BETA)_** Get the experiments configuration. |
