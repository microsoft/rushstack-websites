...
[configuration](./rush-lib.experimentsconfiguration.configuration.md)
...
Readonly&lt;[IExperimentsJson](./rush-lib.iexperimentsjson.md)<></>&gt;


</td><td>

**_(BETA)_** Get the experiments configuration.
