...
| ------------------------------------------------------------------------- | --------------------- | ----------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [canonicalReference](./api-extractor-model.apiitem.canonicalreference.md) | <code>readonly</code> | DeclarationReference                                              | <b><i>(BETA)</i></b> Warning: This API is used internally by API extractor but is not yet ready for general usage.                                                                                                                  |
