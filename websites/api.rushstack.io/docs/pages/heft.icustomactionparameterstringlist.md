...
```
**Extends:** [ICustomActionParameterBase](./heft.icustomactionparameterbase.md)<></>&lt;ReadonlyArray&lt;string&gt;&gt;

## Properties

|  Property | Modifiers | Type | Description |
|  --- | --- | --- | --- |
|  [kind](./heft.icustomactionparameterstringlist.kind.md) |  | 'stringList' | **_(BETA)_** |
