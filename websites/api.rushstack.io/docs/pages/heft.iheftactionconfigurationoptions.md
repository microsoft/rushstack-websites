...
|  --- | --- | --- | --- |
|  [mergeArrays?](./heft.iheftactionconfigurationoptions.mergearrays.md) |  | boolean | _(Optional)_ Whether or not arrays should be merged across Heft action configuration files. |
