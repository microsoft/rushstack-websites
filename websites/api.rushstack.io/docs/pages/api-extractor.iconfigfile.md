...
| [enumMemberOrder?](./api-extractor.iconfigfile.enummemberorder.md)              |           | [EnumMemberOrder](./api-extractor-model.enummemberorder.md)             | <i>(Optional)</i> Specifies how API Extractor sorts members of an enum when generating api.json.                                                                                                                                                 |
