...
[Home](./index.md) &gt; [@rushstack/heft-config-file](./heft-config-file.md) &gt; [ConfigurationFileBase](./heft-config-file.configurationfilebase.md) &gt; [\_loadConfigurationFileInnerWithCache](./heft-config-file.configurationfilebase._loadconfigurationfileinnerwithcache.md)
