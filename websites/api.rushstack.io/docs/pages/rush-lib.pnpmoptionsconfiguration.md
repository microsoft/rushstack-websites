...
| [pnpmStorePath](./rush-lib.pnpmoptionsconfiguration.pnpmstorepath.md)                                   |           | string                                             | The path for PNPM to use as the store directory. Will be overridden by environment variable RUSH_PNPM_STORE_PATH                                                                |
