...
[Home](./index.md) &gt; [@rushstack/ts-command-line](./ts-command-line.md) &gt; [CommandLineParameterBase](./ts-command-line.commandlineparameterbase.md) &gt; [undocumentedSynonyms](./ts-command-line.commandlineparameterbase.undocumentedsynonyms.md)

## CommandLineParameterBase.undocumentedSynonyms property
