...
[Home](./index.md) &gt; [@rushstack/ts-command-line](./ts-command-line.md) &gt; [CommandLineParameterProvider](./ts-command-line.commandlineparameterprovider.md) &gt; [defineChoiceParameter](./ts-command-line.commandlineparameterprovider.definechoiceparameter_3.md)
...
[ICommandLineChoiceDefinition](./ts-command-line.icommandlinechoicedefinition.md)<></>&lt;TChoice&gt;
