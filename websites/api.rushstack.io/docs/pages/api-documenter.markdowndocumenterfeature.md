...
| [onInitialized()](./api-documenter.pluginfeature.oninitialized.md)                                     |                     | <p>This event function is called after the feature is initialized, but before any processing occurs.</p><p>(Inherited from [PluginFeature](./api-documenter.pluginfeature.md) )</p> |
