...
[Home](./index.md) &gt; [@microsoft/api-extractor-model](./api-extractor-model.md) &gt; [ApiExportedMixin](./api-extractor-model.apiexportedmixin.md) &gt; [isBaseClassOf](./api-extractor-model.apiexportedmixin.isbaseclassof.md)

## ApiExportedMixin.isBaseClassOf() function
...
apiItem is [ApiExportedMixin](./api-extractor-model.apiexportedmixin.md)
