...
is designed such that a diff _only_ occurs when a significant contractual change has occurred.
...
- We care about _whether_ people wrote documentation (e.g. presence of the "`// (undocumented)`" warning),
