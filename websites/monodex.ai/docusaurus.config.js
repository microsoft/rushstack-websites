...
const config = {
  ...
  favicon: 'images/site/monodex-logo.svg',
  organizationName: 'microsoft',
  projectName: 'monodex.ai-website',
    ...
    [
      ...
      /** @type {import('@docusaurus/preset-classic').Options} */
      {
        docs: {
          ...
          editUrl: 'https://github.com/microsoft/rushstack-websites/tree/main/websites/monodex.ai/',
          remarkPlugins: [
            [
        ...
        blog: {
          ...
          // Please change this to your repo.
          editUrl: 'https://github.com/microsoft/rushstack-websites/tree/main/websites/monodex.ai/blog/'
        },
        theme: {
  ...
  themeConfig:
    ...
    {
      image: 'images/site/monodex-ograph.jpg',
      navbar: {
        title: '',
        logo: {
          alt: 'Monodex',
          src: 'images/site/monodex-logo.svg'
        },
        items: [
          {
            type: 'localeDropdown',
      ...
      typesense: {
        ...
        typesenseCollectionName: 'monodex.ai',
