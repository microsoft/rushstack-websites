...
export function DecoratedButton(props: React.PropsWithChildren<IDecoratedButtonProps>): JSX.Element {
  ...
  if (props.disabled) {
    ...
    innerStyles.push(
      props.theme === 'white' ? styles.buttonInnerWhiteEffect : styles.buttonInnerRegularEffect
    );
  }

  return (
    <div className={styles.buttonOuter} role="button" tabIndex={0} style={props.style}>
      <div
