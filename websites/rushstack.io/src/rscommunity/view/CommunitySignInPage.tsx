...
export function CommunitySignInPage(props: ICommunitySigninPageProps): JSX.Element {
  return (
    <div className={styles.dialogContainer}>
      <div className={styles.dialogBox}>
        ...
        >
          <DecoratedButton onClick={props.appSession.onNavigateToSignIn} theme="white">
