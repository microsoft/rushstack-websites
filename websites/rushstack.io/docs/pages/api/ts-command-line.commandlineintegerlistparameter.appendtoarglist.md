...
[Home](./index.md) &gt; [@rushstack/ts-command-line](./ts-command-line.md) &gt; [CommandLineIntegerListParameter](./ts-command-line.commandlineintegerlistparameter.md) &gt; [appendToArgList](./ts-command-line.commandlineintegerlistparameter.appendtoarglist.md)

## CommandLineIntegerListParameter.appendToArgList() method
