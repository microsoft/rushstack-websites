...
[Home](./index.md) &gt; [@rushstack/ts-command-line](./ts-command-line.md) &gt; [CommandLineChoiceListParameter](./ts-command-line.commandlinechoicelistparameter.md) &gt; [appendToArgList](./ts-command-line.commandlinechoicelistparameter.appendtoarglist.md)

## CommandLineChoiceListParameter.appendToArgList() method
